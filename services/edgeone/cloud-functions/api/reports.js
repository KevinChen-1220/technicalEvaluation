...
// src/routes/reports.ts
var REASONS = /* @__PURE__ */ new Set(["question_error", "content_safety", "privacy", "other"]);
async function createReportsRoute(request, context, injected) {
  try {
    ...
    const assessmentId = body.assessmentId === void 0 ? void 0 : nonEmptyString(body.assessmentId, 200);
    if ((reason === "question_error" || reason === "content_safety") && assessmentId === void 0) throw invalidRequest();
    ...
    const detail = body.detail === void 0 ? void 0 : nonEmptyString(body.detail, 2e3);
    ...
    await dependencies.stores.reports.create({
      ...
      ...assessmentId === void 0 ? {} : { assessmentId },
      createdAt: timestamp,
      updatedAt: timestamp
    });
    return success({ type: "created", reportId }, 201);
  } catch (error) {
...
function defaultDependencies(context) {
  ...
  return { stores: createEdgeOneStores(context.blob, { now }), now, reportId: import_node_crypto3.randomUUID };
}
