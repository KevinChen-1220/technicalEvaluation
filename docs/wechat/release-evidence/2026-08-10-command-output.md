...
Profile: formal
Generated at: 2026-08-10T10:25:52.159Z
...
Web Bundled 286ms node_modules\expo\AppEntry.js (292 modules)
...
√ Webpack
  Compiled successfully in 5.12s
```
...
### C:\Program Files\nodejs\node.exe scripts/verify-wechat-disclosure.mjs --file docs/wechat/release-disclosure.formal-fixture.tmp.json --mode production --dist apps/wechat/dist
